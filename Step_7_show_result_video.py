...
class GesturesRecognization(QWidget,Ui_MainWindow):
    ...
    def loadfile(self):
        ...
        'choose a video', '/home/fancywu/Desktop/GestureRecognition/temp_materials/samples/',"Image files (*.zip)")
#        print video_file
        if not os.path.exists(video_file):
            ...
            matrix_file = '/home/fancywu/Desktop/GestureRecognition/temp_materials/early_fusion_matrix/' + filename
#            print matrix_file
            self.pred_path = '/home/fancywu/Desktop/GestureRecognition/temp_materials/preditive_data' 
#            print pred_file
